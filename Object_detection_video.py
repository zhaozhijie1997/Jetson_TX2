...
PATH_TO_CKPT = os.path.join(CWD_PATH,MODEL_NAME,'6_class.pb')
...
out = cv2.VideoWriter('test_output/micron_6_class.mp4',cv2.VideoWriter_fourcc('M','J','P','G'), 40, (1280,720))
