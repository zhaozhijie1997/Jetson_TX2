...
def main(argv):
    ...
    #configPath = darknet_path + "cfg/yolov2.cfg"
    weightPath = darknet_path + "yolov3.weights"
    #weightPath = darknet_path + "yolov2.weights"
    metaPath = "coco.data"
    svoPath = None
	...
	# Do the detection
        if(FPS%14==0):
            ...
            for detection in detections:
                ...
                cv2.putText(frame, label , (xCoord+(thickness*4), yCoord+(10 +thickness*4)), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,255,255), 2)
